...
var filename = 'test_InventoryArrival_Warehouse';
...
describe(filename, function () {
  ...
  it('verify InventoryArrival_Warehouse', function () {
    var result = Warehouse.evalMetric({
      id: this.warehouse.id,
      expression: 'InventoryArrival',
      start: '2018-01-01',
      end: '2018-01-07',
      interval: 'DAY',
    });

    expect(result.data()).toEqual([0, 10, 0, 20, 5, 0]);
  });
});
