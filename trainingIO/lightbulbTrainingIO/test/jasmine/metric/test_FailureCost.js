...
describe(filename, function () {
  ...
  it('verify FailureCost in day interval', function () {
    var result = Warehouse.evalMetric({
      id: this.warehouse.id,
      expression: 'FailureCost',
      start: '2018-01-01',
      end: '2018-01-05',
      interval: 'DAY',
    });

    expect(result.data()).toEqual([0, 0, 5, 15]);
  });
});
